...
<div id="contactModal" class="hidden animate-fade-in fixed inset-0 z-50 overflow-auto bg-black bg-opacity-40 text-color2 dark:text-colorContrast">
    <div class="flex items-center justify-center min-h-screen modal-inside">
      <div class="bg-white border border-color4 rounded-lg p-5 lg:p-10 relative animate-scaleUp modal-content dark:bg-black dark:border-colorContrast ">
        ...
        <div class="mt-4">
                <a href="tel:+123 456 789" class="flex items-center group/item">
                  ...
                  <span class="ml-2 group-hover/item:text-color3 transition-all duration-500 ease-in-out">+123 456 789</span>
                </a>
                <a href="mailto:email@example.com" class="flex items-center mt-3 group/item">
                  ...
                  <span class="ml-2 group-hover/item:text-color3 transition-all duration-500 ease-in-out">email@example.com</span>
                </a>
        </div>
      </div>
    </div>
