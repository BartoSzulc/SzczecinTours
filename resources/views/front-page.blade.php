    ...
    <section class="home__travels ">
        <div class="container">
            ...
            <div id="search-tours" class="relative max-lg:mb-10 flex max-xl:flex-wrap gap-5 items-center justify-between bg-white dark:bg-black py-5 px-0 md:px-5 3xl:px-30 rounded-md transition-all duration-500 ease-in-out">
                ...
                <div class="right flex flex-wrap max-lg:gap-5 items-center justify-center max-xl:w-full relative z-10">
            ...
            <div class="max-lg:hidden 2xl:flex items-center justify-stretch py-10 category-picker gap-y-5 2xl:gap-x-10 gap-x-5 flex-wrap max-2xl:grid max-2xl:grid-cols-4 relative z-10">
